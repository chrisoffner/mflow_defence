...
if __name__ == "__main__":
    ...
    FIGURES_DIR = Path("/Users/chrisoffner3d/Documents/Dev/ETH/CIL Project Code/manifold-flow/figures/spiral_boundaries_noise_20")
    OUTPUT_PATH = FIGURES_DIR / "spiral_boundaries_noise_20.mp4"
